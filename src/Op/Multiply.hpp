...
Variant OP_Multiply_exec(Operation& op, ScopeState& state, Variant& first, Variant& second, std::string symbol) {
	CheckOperationExec(op, state, first, second, "multiply");
